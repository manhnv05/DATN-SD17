...
public interface HoaDonMapper {
    ...
    @Mapping(target = "tenKhachHang", expression = "java(hoaDon.getKhachHang() != null ? hoaDon.getKhachHang().getTenKhachHang() : null)")    // Map tenNhanVien: Nếu có thực thể nhân viên, lấy tên từ đó. Nếu không, trả về null.
