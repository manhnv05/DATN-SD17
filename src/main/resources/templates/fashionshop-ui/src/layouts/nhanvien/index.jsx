...
// Chỉ lấy tên vai trò thôi, ưu tiên tenVaiTro, sau đó vaiTro.ten, rồi vaiTro string
function getRoleName(row) {
    if (row && row.tenVaiTro) return row.tenVaiTro;
    if (row && row.vaiTro && typeof row.vaiTro === "object" && row.vaiTro.ten) return row.vaiTro.ten;
    if (row && typeof row.vaiTro === "string") return row.vaiTro;
