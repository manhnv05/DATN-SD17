...
export default function ProductDetail() {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:8080/api/outlet/products", {
            ...
            setRelatedProducts(rel.map(item => ({
                id: item.id,
                    ...
                    <Grid item xs={12} md={6}>
                            ...
                            <Stack direction="row" alignItems="center" spacing={2} sx={{ mb: 2 }}>
                                ...
                                <Stack direction="row" flexWrap="wrap" gap={1.2}>
                                    {product.colors.map((color, idx) => (
                                        <Tooltip title={color.name || color.tenMauSac || color.value || color} key={color.value || color.tenMauSac || color.maMau || idx}>
                                            <IconButton
                                                sx={{
                                                    border: selectedColor && (selectedColor.value === (color.value || color.maMau) || selectedColor.tenMauSac === color.tenMauSac)
                                                        ? "2.5px solid #1976d2"
                                                        : "2px solid #e3e3e3",
                        ...
                        <Stack direction="row" alignItems="center" spacing={2} sx={{ mb: 3 }}>
                            ...
                            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                                ...
                                <Typography sx={{ minWidth: 32, textAlign: "center", color: "#1976d2", fontWeight: 700 }}>{quantity}</Typography>
                                <Button variant="outlined" size="small" sx={{
                                    minWidth: 32,
                                    px: 0,
                                    borderColor: "#1976d2",
